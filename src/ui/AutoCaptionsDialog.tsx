        ...
        <div className="-mx-1 mt-4 min-h-0 flex-1 overflow-y-auto scrollbar-none px-1">
          ...
          {available === null || (!hosted && status === null) ? (
            ...
            <>
              {credentialsBlock}
              {languagePicker}
              {/* Chosen up front — the whole batch of captions this job produces lands with this look,
                  rather than a fixed caption default that then needs restyling clip by clip afterward. */}
              ...
              {/* Same "chosen up front" reasoning as Style just above — landing every caption clip
                  already animated (e.g. a word-highlight karaoke look) skips a separate "select them
                  all, then apply the toolbar's own Animation tool" step afterward. */}
